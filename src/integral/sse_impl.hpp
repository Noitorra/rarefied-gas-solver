...
namespace sse {
	...
	template <>
	inline __m128d polyLog<5>(__m128d x) {
	...
	inline __m128d log(__m128d x) {
		...
		__m128i exponent = _mm_castpd_si128(x); //?????
		__m128i mant = _mm_castpd_si128(x); //?????
